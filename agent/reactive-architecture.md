...
Canonical examples in this project: `Game` in [src/lib/Game.svelte.ts](src/lib/Game.svelte.ts), `createTimer` in [src/lib/timer.svelte.ts](src/lib/timer.svelte.ts).
